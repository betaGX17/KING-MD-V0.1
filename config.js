...
const baseConfig = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "king",
    BOT_NAME: process.env.BOT_NAME || 'king',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '༺☆Ｙศ𝗺ᾰт𝗈ę𝔫𝘥𝚘☆༻;KING-MD bot;https://i.pinimg.com/736x/b9/34/b8/b934b8ec10842d2db7a0566f460546ce.jpg' : process.env.AUDIO_DATA,
